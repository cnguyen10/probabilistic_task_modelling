...
class OmniglotLoader(object):
    ...
    def __init__(
        ...
        """
        self.root = os.path.join(root, 'images_background_64' if train_subset else 'images_evaluation_64')
        self.suffix = suffix
    ...
    def generate_episode(self, episode_name: _typing.Optional[_typing.List[str]] = None) -> _typing.List[np.ndarray]:
